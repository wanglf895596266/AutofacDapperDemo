...
namespace Dapper
{
    ...
    public partial class SimpleCRUD
    {
        ...
        public int? Insert(IDbConnection connection, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            #region Extension
        ...
        public TKey Insert<TKey>(IDbConnection connection, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public int Update(IDbConnection connection, object entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null)
        {
