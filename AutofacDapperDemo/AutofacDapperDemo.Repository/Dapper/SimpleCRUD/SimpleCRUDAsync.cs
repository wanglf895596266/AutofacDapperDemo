...
namespace Dapper
{
    ...
    public partial class SimpleCRUD
    {
        ...
        public async Task<T> GetAsync<T>(IDbConnection connection, object id, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            BuildAttributeConditions(sb, (T)Activator.CreateInstance(typeof(T)), dynParms);
        ...
        public Task<int?> InsertAsync(IDbConnection connection, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            #region Extension

            BuildDefaultAttributeValue(entityToInsert);
        ...
        public async Task<TKey> InsertAsync<TKey>(IDbConnection connection, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public Task<int> UpdateAsync(IDbConnection connection, object entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null, System.Threading.CancellationToken? token = null)
        {
            ...
            var parameters = BuildParameters(entityToUpdate);
            BuildAttributeConditions(sb, entityToUpdate, parameters);
        ...
        public Task<int> DeleteAsync<T>(IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            var parameters = BuildParameters(entityToDelete);
            BuildAttributeConditions(sb, entityToDelete, parameters);
